...
Codex install:   copy this file's body into your repo's AGENTS.md (or
                 ~/.codex/AGENTS.md for global use), or reference it from
                 there: "For any Seedance extension work, follow
                 studio/skills/seedance-shot-extension/SKILL.md exactly."
Claude install:  drop this folder into .claude/skills/ as-is.

Sibling skill:   seedance-scene-wrapper owns scene grammar (establish /
                 coverage / button) and held-frame chaining semantics
                 (chain_cut / chain_continue). This skill owns continuing a
                 shot past its generation boundary from a source CLIP. They
                 share one vocabulary; neither restates the other's laws.
-->
